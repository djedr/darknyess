...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("23turtles", "darknyeß", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "darknyeß";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "darknyeß", null, { width: 640, height: 480 });
