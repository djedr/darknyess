...
@:font("/usr/share/haxe/lib/flixel/3,3,11/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends flash.text.Font {}
@:font("/usr/share/haxe/lib/flixel/3,3,11/assets/fonts/arial.ttf") @:keep #if display private #end class __ASSET__assets_fonts_arial_ttf extends flash.text.Font {}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/background_night.png", AssetType.IMAGE);
		path.set ("assets/images/platforms.png", "assets/images/platforms.png");
		type.set ("assets/images/platforms.png", AssetType.IMAGE);
		path.set ("assets/images/ludzik.png", "assets/images/ludzik.png");
		type.set ("assets/images/ludzik.png", AssetType.IMAGE);
		path.set ("assets/images/ludzik (kopia).png", "assets/images/ludzik (kopia).png");
		type.set ("assets/images/ludzik (kopia).png", AssetType.IMAGE);
		...
		var id;
		id = "assets/images/background_night.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/platforms.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/ludzik.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/ludzik (kopia).png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
...
@:font("/usr/share/haxe/lib/flixel/3,3,11/assets/fonts/nokiafc22.ttf") #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends lime.text.Font {}
@:font("/usr/share/haxe/lib/flixel/3,3,11/assets/fonts/arial.ttf") #if display private #end class __ASSET__assets_fonts_arial_ttf extends lime.text.Font {}
